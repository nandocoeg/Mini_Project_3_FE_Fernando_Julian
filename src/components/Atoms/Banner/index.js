...
const Banner = () => {
  return (
    <div className="container bg-black text-white h-[70vh]">
      <div class="relative flex">
        <img
          ...
          class="object-cover"
        />
        <div class="absolute inset-0 bg-gradient-to-t from-black from-45% to-transparent flex justify-center items-end"></div>
      </div>
    </div>
  );
};
